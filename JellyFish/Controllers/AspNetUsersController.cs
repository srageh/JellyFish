...
namespace JellyFish.Controllers
{
    ...
    {
        private readonly JellyFishContext _context;

        public AspNetUsersController(JellyFishContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'JellyFishContext.AspNetUsers'  is null.");
            }
            var aspNetUser = await _context.AspNetUsers.FindAsync(id);
            if (aspNetUser != null)
            {
